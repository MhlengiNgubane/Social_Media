...
class Post(models.Model):
    ...
    media = models.FileField(upload_to='media/posts/', blank=True, null=True)  # For images and videos
    ...
    hashtags = models.ManyToManyField(Hashtag, blank=True, related_name='posts')  # Ensure correct related name
...
class Comment(models.Model):
    ...
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    content = models.TextField()
    media = models.FileField(upload_to='media/comments/', blank=True, null=True)  # For images and videos
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
